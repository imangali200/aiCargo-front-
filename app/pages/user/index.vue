...
function getWhatsAppLink() {
    const phoneNumber = '77083791496'
    const userCode = userProfile.value?.code || ''
    const message = encodeURIComponent(`Здравствуйте. Прошу вас зарегистрировать меня на сайте Ai-MARKET. Я клиент Ai-CARGO. Мой индивидуальный код: ${userCode}Саламатсыз ба! ${userCode}`)
